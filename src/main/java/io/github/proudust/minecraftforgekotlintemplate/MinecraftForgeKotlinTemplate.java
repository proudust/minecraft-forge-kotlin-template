...
public class MinecraftForgeKotlinTemplate {

    public static final String MOD_ID = "minecraft-forge-kotlin-template";
    public static final String MOD_NAME = "Minecraft Forge Kotlin Template";
     ...
     */
    @Mod.Instance(MOD_ID)
    public static MinecraftForgeKotlinTemplate INSTANCE;
